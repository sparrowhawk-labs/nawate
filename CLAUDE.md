...
- Sibling verification harness (Phase 5 demo app, EC-mock fixtures + fragments): `~/project/nawate-demo-app` (local git, no remote — directory name predates the jess rename, not renamed)
